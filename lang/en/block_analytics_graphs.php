...
/**
 * English language strings for the analytics graphs block.
 *
...
$string['privacy:metadata:block_analytics_graphs_msg:message'] = 'Content of the message.';
$string['privacy:metadata:block_analytics_graphs_msg:courseid'] = 'The ID of the course the message was sent in.';
$string['privacy:metadata:block_analytics_graphs_msg:timecreated'] = 'The time when the message was sent.';
